...
{
    class GetRootThemesByUserNameHandler : IRequestHandler<GetRootThemesByUserIdQuery, List<ThemeDto>>
    {
        ...
        public Task<List<ThemeDto>> Handle(GetRootThemesByUserIdQuery request, CancellationToken cancellationToken)
        {
